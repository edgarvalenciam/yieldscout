...
export const BENCHMARKS: BenchmarkProduct[] = [
  {
    ...
    name: "CETES 28 días",
    country: "MX",
    apyAnnual: 10.75, // Verificar en banxico.org.mx — actualizar semanalmente
    source: "Banxico",
    description:
  ...
  },
  {
    ...
    country: "ES",
    apyAnnual: 2.8, // Verificar en tesoro.gob.es — actualizar semanalmente
    source: "Tesoro.gob.es",
    description:
